                  ...
                  <div className="flex flex-col gap-3.5 items-end justify-start w-full">
                    ...
                    <div className="flex flex-col gap-4 items-center justify-start w-full">
                      <div className="flex md:flex-col flex-row gap-6 items-center justify-between w-full">
                        ...
                        <div className="bg-white-A700 flex md:flex-1 flex-col items-center justify-start p-2.5 rounded-[10px] w-[49%] md:w-full">
                          <div className="h-[22px] md:h-[33px] mb-1 mt-[7px] relative w-[98%]">
                            ...
                            <Radio
                              ...
                              inputClassName="absolute border border-pink-400 border-solid h-4 mr-[5px] rounded-lg w-4"
                              checked={true}
                              name="twenty1"
                              label="20 "
                              id="20"
