        ...
        <div className="flex md:flex-col flex-row font-tajawal md:gap-10 gap-[70px] items-start justify-center max-w-[1076px] mx-auto md:px-5 w-full">
                        ...
                        <div className="flex flex-row gap-2 items-center justify-between mt-[11px] w-1/2">
                          <div className="flex flex-col items-center justify-start">
                            <div className="flex flex-col justify-start w-full">
                              <Text
                                className="capitalize md:ml-[0] ml-[74px] text-gray-900 text-lg text-right"
                                size="txtTajawalBold18"
                              >
                                محمد سعد
                              </Text>
                              <div className="flex flex-row items-start justify-start mr-[22px] mt-1 w-[87%] md:w-full">
                                <Img
                                ...
                                />
                                <Text
                                  className="capitalize mb-0.5 text-indigo-300 text-lg"
          ...
          <div className="flex md:flex-1 flex-col items-center justify-start md:mt-0 mt-[3px] w-[46%] md:w-full">
            <div className="bg-white-A700 flex flex-col gap-8 items-end justify-start p-6 sm:px-5 rounded-[10px] w-auto sm:w-full">
              ...
              <div className="flex flex-col gap-[18px] items-center justify-start w-full">
                <div className="h-[510px] md:h-[580px] relative w-full">
                      ...
                      >
                        ...
                        <div className="flex flex-1 flex-row items-center justify-between my-0 w-full">
                          ...
                          <div className="flex flex-row gap-4 items-center justify-between w-[42%]">
                            ...
                            >
                              <Img
                                src="images/img_group176_white_a700.svg"
                                alt="group176"
                              />
                            </Button>
                          </div>
                  ...
                  <Img
                    ...
                    src="images/img_group1171276032_teal_500.svg"
                    alt="group1171276032"
                  />
                </div>
                <div className="flex flex-row items-center justify-between w-full">
              ...
              <div className="flex sm:flex-col flex-row gap-[37.86px] items-start justify-end w-auto sm:w-full">
                <Button
                  className="cursor-pointer font-bold min-w-[136px] rounded-[17px] text-base text-center"
                  color="pink_400"
                  size="2xl"
                  variant="fill"
                >
                ...
                <Button
                  className="cursor-pointer font-bold min-w-[117px] rounded-[17px] text-base text-center"
                  color="pink_400"
                  size="3xl"
                  variant="fill"
                >
              ...
              <div className="flex flex-col items-center justify-start w-full">
                <Button
                  className="common-pointer cursor-pointer font-bold leading-[normal] min-w-[446px] sm:min-w-full text-2xl md:text-[22px] text-center sm:text-xl"
