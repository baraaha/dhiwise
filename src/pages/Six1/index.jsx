...
const Six1Page = () => {
  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col items-center justify-start mx-auto pb-40 w-full">
        <div className="flex flex-col items-center justify-start w-full">
          <Header1 className="flex flex-col font-worksans items-center justify-center md:px-5 w-full" />
          ...
          <Button
            className="cursor-pointer font-medium font-tajawal leading-[normal] min-w-[69px] mt-7 rounded-md text-[10.62px] text-center"
            color="light_green_600_0c"
            size="sm"
            variant="fill"
          >
            جاري التجهيز
          </Button>
          <div className="flex sm:flex-col flex-row font-tajawal gap-6 items-start justify-start mt-3 md:px-5 w-auto sm:w-full">
            <Button
            ...
            <Button
              className="capitalize cursor-pointer font-medium leading-[normal] min-w-[166px] text-2xl md:text-[22px] text-center sm:text-xl"
              shape="round"
              color="pink_400"
              size="lg"
              variant="fill"
          ...
          <div className="font-tajawal md:gap-5 gap-6 grid md:grid-cols-1 grid-cols-2 justify-center max-w-[1272px] min-h-[auto] mt-[117px] mx-auto md:px-5 w-full">
            <div className="bg-white-A700 flex flex-1 flex-col items-center justify-start p-4 rounded-[20px] w-full">
              <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-full">
                <div className="flex sm:flex-1 flex-col gap-[52px] items-start justify-start w-1/5 sm:w-full">
                  <Button
                    className="cursor-pointer font-medium leading-[normal] min-w-[113px] rounded-[10px] text-base text-center"
                    shape="round"
                    color="light_blue_800_0c"
                    size="md"
                    variant="fill"
                  >
                    جاري التوصيل
            ...
            <div className="bg-white-A700 flex flex-1 flex-col items-center justify-start p-4 rounded-[20px] w-full">
              <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-full">
                <div className="flex sm:flex-1 flex-col gap-[52px] items-start justify-start w-[18%] sm:w-full">
                  <Button
                    className="cursor-pointer font-medium leading-[normal] min-w-[104px] rounded-[10px] text-base text-center"
                    shape="round"
                    color="light_green_600_0c"
                    size="md"
                    variant="fill"
            ...
            <div className="bg-white-A700 flex flex-1 flex-col items-center justify-start p-4 rounded-[20px] w-full">
              <div className="flex flex-col gap-[11px] items-center justify-start w-full">
                ...
                <div className="flex flex-row sm:gap-10 items-end justify-between w-full">
                  <Button
                    className="border border-pink-400 border-solid flex h-[52px] items-center justify-center mt-[41px] rotate-[180deg] rounded-[10px] w-[52px]"
                    shape="round"
                    color="pink_400"
                    size="xl"
                    variant="fill"
                  ...
                  <div className="flex flex-row gap-4 items-start justify-between w-1/2">
                    <div className="flex flex-col gap-2.5 items-end justify-start mt-[9px]">
                      <Text
                        className="text-gray-900 text-lg text-right"
                        size="txtTajawalBold18"
