...
const SixPage = () => {
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-worksans sm:gap-10 md:gap-10 gap-[100px] items-center justify-start mx-auto pb-[155px] w-full">
        ...
        <div className="flex md:flex-col flex-row font-tajawal md:gap-10 gap-[70px] items-start justify-center max-w-[1076px] mx-auto md:px-5 w-full">
          ...
          <div className="bg-white-A700 flex sm:flex-1 flex-col gap-8 items-center justify-start mb-[49px] md:mt-0 mt-[3px] p-6 sm:px-5 rounded-[10px] w-auto sm:w-full">
            ...
            <div className="flex flex-col gap-[21px] items-center justify-start w-full">
              <div className="h-[507px] md:h-[580px] relative w-full">
                ...
                <Img
                  ...
                  src="images/img_group1171276032_blue_50_01.svg"
                  alt="group1171276032"
                />
              </div>
              <div className="flex flex-row items-center justify-between w-full">
            ...
            <Text
              className="text-2xl md:text-[22px] text-pink-400 sm:text-xl w-auto"
              size="txtTajawalMedium24Pink400"
            >
              قام سهول بإلغاء الطلب الخاص بك
            </Text>
          </div>
        </div>
      </div>
