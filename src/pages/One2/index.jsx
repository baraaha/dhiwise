      ...
      <div className="bg-gray-50 flex flex-col font-worksans gap-8 items-center justify-start mx-auto pb-7 w-full">
        ...
        <div className="flex flex-col font-tajawal items-center justify-start max-w-[1312px] mx-auto md:px-5 w-full">
          <div className="flex flex-col items-center justify-end w-full">
            <div className="sm:h-[1079px] h-[1124px] md:h-[1652px] relative w-full">
              <div className="absolute bg-white-A700 flex flex-col inset-x-[0] items-end justify-start mx-auto p-8 sm:px-5 rounded-[20px] top-[0] w-full">
                <div className="bg-gray-50 md:h-[691px] h-[725px] p-2.5 relative rounded-[10px] w-[33%] sm:w-full">
              ...
              <div className="absolute bottom-[0] flex flex-col items-center justify-start left-[2%] w-[62%]">
                <div className="flex flex-col gap-[25px] items-end justify-start w-full">
                    ...
                    >
                      <div className="bg-gray-50 flex flex-1 flex-col gap-8 justify-start pb-6 rounded-[20px] w-full">
                        ...
                        <div className="flex flex-row gap-2 items-start justify-end md:ml-[0] ml-[239px] w-[35%] md:w-full">
                          ...
                          <Img
                            ...
                            src="images/img_television_green_a700_12x20.svg"
                            alt="television"
                          />
                        </div>
                        ...
                        <div className="flex flex-row gap-2.5 items-start justify-end md:ml-[0] ml-[139px] w-3/5 md:w-full">
                          ...
                          <Img
                            className="h-[19px]"
                            src="images/img_thumbsup_19x16.svg"
                            alt="thumbsup"
                          />
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-start ml-4 md:ml-[0] w-[92%] md:w-full">
                          ...
                          <div className="flex flex-row gap-[11px] items-start justify-between mt-[26px] w-full">
                            ...
                            <Img
                              ...
                              src="images/img_printer_blue_gray_500_15x16.svg"
                              alt="printer"
                            />
                          </div>
                          <Button
                      ...
                      <div className="bg-gray-50 flex flex-1 flex-col gap-8 justify-start pb-6 rounded-[20px] w-full">
                        ...
                        <div className="flex flex-row gap-2 items-start justify-end md:ml-[0] ml-[239px] w-[35%] md:w-full">
                          ...
                          <Img
                            className="h-3 mt-[3px]"
                            src="images/img_television_12x20.svg"
                            alt="television"
                          />
                        </div>
                        <div className="flex flex-row gap-2.5 items-start justify-end md:ml-[0] ml-[113px] w-[67%] md:w-full">
                        ...
                        <div className="flex flex-col gap-8 items-center justify-start ml-4 md:ml-[0] w-[92%] md:w-full">
                          <div className="flex flex-row gap-[11px] items-start justify-between w-full">
                            ...
                            <Img
                              className="h-[15px] w-4"
                              src="images/img_printer_15x16.svg"
                              alt="printer"
                            />
                          </div>
                          <Button
                  ...
                  <div className="bg-gray-50 flex flex-col gap-8 items-center justify-start pb-8 rounded-[20px] w-[49%] md:w-full">
                    ...
                    <div className="flex flex-col gap-[33px] items-start justify-start w-[67%] md:w-full">
                      ...
                      <div className="flex flex-row gap-2.5 items-start justify-end md:ml-[0] ml-[26px] w-[90%] md:w-full">
                        ...
                        <Img
                          className="h-[19px]"
                          src="images/img_thumbsup_2.svg"
                          alt="thumbsup"
                        />
                      </div>
                      <div className="flex flex-row gap-2 items-start justify-end md:ml-[0] ml-[119px] w-[55%] md:w-full">
                        <Text
                          className="text-black-900 text-lg text-right"
                          size="txtTajawalMedium18"
                        >
                    ...
                    <div className="flex flex-col gap-8 items-center justify-start w-[92%] md:w-full">
                      <div className="flex flex-row gap-[18px] items-center justify-between w-full">
                        ...
                        <div className="flex flex-row gap-2.5 items-start justify-between w-[65%]">
                          <Text
                            className="text-black-900 text-lg text-right"
                            size="txtTajawalMedium18"
                          >
