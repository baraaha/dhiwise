...
const Page9 = () => {
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-worksans sm:gap-10 md:gap-10 gap-[89px] items-center justify-start mx-auto pb-[197px] w-full">
        <Header className="flex flex-col items-center justify-center md:px-5 shadow-bs2 w-full" />
        <div className="flex flex-col font-tajawal items-center justify-start max-w-[1099px] mx-auto md:px-5 w-full">
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
            <div className="flex md:flex-1 flex-col gap-[19px] items-end justify-start w-[47%] md:w-full">
              ...
              <div className="flex flex-col gap-6 items-center justify-start w-full">
                ...
                <div className="bg-white-A700 flex flex-col items-end justify-end p-[13px] rounded-[10px] w-full">
                  <div className="flex flex-col gap-5 items-end justify-start mr-0.5">
                    <Text
                      className="text-2xl md:text-[22px] text-black-900 text-right sm:text-xl"
                      size="txtTajawalBold24"
                    >
            ...
            <div className="bg-white-A700 flex md:flex-1 flex-col gap-[31px] items-end justify-end mb-[357px] md:mt-0 mt-[9px] p-6 sm:px-5 rounded-[20px] w-[48%] md:w-full">
              <Text
                ...
                <div className="flex flex-col items-center justify-start mt-3.5 w-[96%] md:w-full">
                  <div className="flex flex-col gap-3.5 items-end justify-start w-full">
                    ...
                    <div className="bg-gray-50 flex flex-col items-center justify-end p-2.5 rounded-[10px] w-full">
                      ...
                      >
                        ناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء
