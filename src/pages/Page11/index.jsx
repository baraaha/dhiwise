...
const Page11 = () => {
  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-worksans items-center justify-start mx-auto pb-[125px] w-full">
        <div className="flex flex-col md:gap-10 gap-[77px] items-center justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row font-tajawal md:gap-10 gap-[85px] items-start justify-start max-w-[1232px] mx-auto md:px-5 w-full">
            <div className="bg-white-A700 flex md:flex-1 flex-col items-end justify-end py-[11px] rounded-[20px] shadow-bs3 w-[42%] md:w-full">
              <div className="flex flex-row items-end justify-end mr-6 mt-3 w-[34%] md:w-full">
                <Text
                ...
                <Text
                  className="capitalize ml-1 md:text-3xl sm:text-[28px] text-[32px] text-black-900"
              ...
              <div className="flex flex-col font-montserrat items-center justify-start mr-6 mt-[23px] w-[91%] md:w-full">
                ...
                <div className="bg-white-A700 flex flex-col font-tajawal items-center justify-start mt-[43px] outline outline-[1px] outline-blue_gray-50_02 p-[15px] rounded-[15px] w-full">
                  <div className="flex flex-col items-end justify-start mb-4 w-full">
                    ...
                    <Text
                      className="leading-[27.00px] mt-[5px] text-blue_gray-600 text-lg text-right w-[89%] sm:w-full"
                      size="txtTajawalMedium18Bluegray600"
                    >
                      سوف يتم توصيل هذا الطلب بمعرفتنا الى (جمعية البر الخيرية)
                      وستصلك رسالة من الجمعية بتأكيد استلام الطلب بعد التوصيل
                    </Text>
                  </div>
                </div>
                <div className="bg-gray-50 flex flex-col font-tajawal items-center justify-start mt-[35px] p-4 rounded-[20px] w-full">
            ...
            <div className="flex md:flex-1 flex-col items-start justify-start md:mt-0 mt-[49px] w-[52%] md:w-full">
                ...
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="flex flex-col gap-3.5 items-end justify-start w-full">
                    ...
                    <div className="flex md:flex-col flex-row gap-6 items-center justify-between w-full">
                      ...
                      <div className="bg-white-A700 flex md:flex-1 flex-col items-center justify-end p-3.5 rounded-[10px] w-[49%] md:w-full">
                        <div className="flex flex-row items-start justify-start w-[99%] md:w-full">
                          <Img
                            ...
                            alt="arrowdown_One"
                          />
                          <div className="flex flex-col items-center justify-start ml-[139px] mt-0.5">
                            <Text
                  ...
                  <div className="flex flex-col gap-3.5 items-end justify-start w-full">
                    ...
                    <div className="flex flex-col gap-4 items-center justify-start w-full">
                      <div className="flex md:flex-col flex-row gap-6 items-center justify-between w-full">
                        ...
                        <div className="bg-white-A700 flex md:flex-1 flex-row font-jfflat gap-[13px] items-center justify-start p-2.5 rounded-[10px] w-[49%] md:w-full">
                          <div className="flex flex-row gap-[26px] items-center justify-between mb-1 mt-[7px] w-[88%]">
                            <Text
                              className="text-[13px] text-teal-500"
                              size="txtJFFlatMedium13"
                            >
                              20 ريال
                            </Text>
                      ...
                      <div className="flex md:flex-col flex-row gap-6 items-start justify-between w-full">
                        ...
                        <div className="bg-white-A700 flex md:flex-1 flex-col items-center justify-end p-[11px] rounded-[10px] w-[49%] md:w-full">
                          <div className="flex flex-col gap-[9px] justify-start mt-1.5 w-[98%] md:w-full">
                            <div className="flex flex-row gap-[13px] items-center justify-end md:ml-[0] ml-[68px] w-[76%] md:w-full">
                            ...
                            <div className="flex flex-row font-jfflat gap-[39px] items-start justify-start mr-[30px] w-[89%] md:w-full">
                              <Button
              ...
              <div className="flex flex-col items-center justify-start md:ml-[0] ml-[419px] mt-8 w-[34%] md:w-full">
                <div className="flex flex-col items-center justify-start w-full">
                  <Button
