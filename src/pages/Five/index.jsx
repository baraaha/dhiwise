...
const FivePage = () => {
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-worksans sm:gap-10 md:gap-10 gap-[93px] items-center justify-start mx-auto pb-[193px] w-full">
        ...
        <div className="flex md:flex-col flex-row font-tajawal md:gap-10 gap-[70px] items-start justify-center max-w-[1099px] mx-auto md:px-5 w-full">
          <div className="flex md:flex-1 flex-col gap-[19px] items-end justify-start w-[47%] md:w-full">
            ...
            <div className="flex flex-col gap-6 items-center justify-start w-full">
              ...
              <div className="bg-white-A700 flex flex-col items-end justify-end p-[11px] rounded-[10px] w-full">
                <div className="flex flex-col gap-[21px] items-end justify-start mr-1 mt-0.5">
                  <Text
                    className="text-2xl md:text-[22px] text-black-900 text-right sm:text-xl"
                    size="txtTajawalBold24"
                  >
                  ...
                  <Text
                    className="text-blue_gray-600 text-center text-lg"
              ...
              <div className="bg-white-A700 flex flex-col items-end justify-start p-[11px] rounded-[10px] w-full">
                <div className="flex flex-col gap-[19px] items-end justify-start mb-0.5 mr-1 w-[68%] md:w-full">
                  <Text
                    className="text-2xl md:text-[22px] text-black-900 text-right sm:text-xl"
                    size="txtTajawalBold24"
                  >
              ...
              <div className="bg-white-A700 flex flex-row items-start justify-between p-[11px] rounded-[10px] w-full">
                <Text
                  className="capitalize ml-1 text-lg text-right text-teal-500"
                  size="txtTajawalMedium18Teal500"
                >
                  انا المستلم
                </Text>
                <div className="h-[67px] md:h-[72px] mb-[5px] mr-1 relative w-[34%]">
                  <Img
                    className="absolute bottom-[0] h-6 right-[0] w-6"
                    src="images/img_settings_indigo_100_24x24.svg"
                    alt="settings_One"
                  />
                  <div className="absolute flex flex-col gap-4 h-full inset-[0] justify-center m-auto w-full">
                    <Text
                      className="md:ml-[0] ml-[15px] text-2xl md:text-[22px] text-black-900 text-right sm:text-xl"
                      size="txtTajawalBold24"
                    >
                      عنوان التسليم
                    </Text>
                    <Text
                      className="capitalize text-blue_gray-600 text-lg text-right"
                      size="txtTajawalMedium18Bluegray600"
                    >
                      جمعية البر الخيرية
                    </Text>
                ...
                <div className="flex flex-col items-center justify-start mb-[5px] w-[98%] md:w-full">
                  <div className="flex flex-col gap-[19px] items-end justify-start w-full">
                    ...
                    <div className="flex sm:flex-col flex-row sm:gap-[51px] items-center justify-between w-full">
                      <div className="flex sm:flex-1 flex-row items-start justify-evenly w-[65%] sm:w-full">
                        <div className="flex flex-col items-center justify-start">
                          <Text
                      ...
                      <div className="flex sm:flex-1 flex-row gap-2.5 items-start justify-between w-1/4 sm:w-full">
                        <div className="flex flex-col items-center justify-start">
                          <Text
                            className="text-center text-gray-900 text-lg"
                            size="txtTajawalMedium18Gray900"
          ...
          <div className="bg-white-A700 flex md:flex-1 flex-col gap-[31px] items-end justify-end mb-[361px] md:mt-0 mt-[5px] p-6 sm:px-5 rounded-[20px] w-[48%] md:w-full">
            <Text
