                  ...
                  <div className="flex flex-col gap-3.5 items-end justify-start w-full">
                    ...
                    <div className="flex flex-col gap-4 items-center justify-start w-full">
                      ...
                      <div className="flex md:flex-col flex-row gap-6 items-start justify-between w-full">
                        <div className="bg-white-A700 flex md:flex-1 flex-col items-center justify-end mb-9 p-3.5 rounded-[10px] w-[49%] md:w-full">
                          <div className="flex flex-row gap-[15px] items-start justify-between mt-[3px] w-[99%] md:w-full">
                            ...
                            <div className="border border-pink-400 border-solid flex flex-col h-4 items-center justify-start mt-0.5 p-[3px] rounded-[50%] w-4">
                              <div className="bg-pink-400 h-2.5 rounded-[50%] w-2.5"></div>
                            </div>
                          </div>
                        </div>
                        <div
                          className="common-pointer bg-white-A700 flex md:flex-1 flex-col items-center justify-end p-2.5 rounded-[10px] w-[49%] md:w-full"
