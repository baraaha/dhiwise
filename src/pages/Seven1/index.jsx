...
const Seven1Page = () => {
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-worksans sm:gap-10 md:gap-10 gap-[100px] items-center justify-start mx-auto pb-1.5 w-full">
              ...
              <div className="flex flex-col gap-[18px] items-center justify-start w-full">
                <div className="h-[510px] md:h-[580px] relative w-full">
                  ...
                  <Img
                    ...
                    src="images/img_group1171276032_460x1.svg"
                    alt="group1171276032"
                  />
                </div>
                <div className="flex flex-row items-center justify-between w-full">
