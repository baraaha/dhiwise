  ...
  return (
    <>
      <div className={props.className}>
        <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between md:ml-[0] ml-[75px] w-[82%] md:w-full">
              ...
              <div className="md:h-[23px] h-[25px] relative w-6">
                <div className="flex flex-col h-full items-center justify-start ml-auto w-1.5">
                  <div
                    ...
                    style={{
                      backgroundImage: "url('images/img_group1171275634.svg')",
                    }}
                  >
                    <Text
          ...
          <div className="flex flex-col gap-[5px] items-start justify-start mb-1 md:mt-0 mt-[13px] w-[64%] md:w-full">
            <div className="flex flex-col items-center justify-start rotate-[-180deg] w-full">
              <div className="flex flex-col items-center justify-start w-full">
                <ul className="flex md:flex-col flex-row gap-[50px] items-center justify-start rotate-[-180deg] w-auto md:w-full">
                  <li>
                    <a
                      href="javascript:"
                  ...
                  <li>
                    <a className="capitalize text-2xl md:text-[22px] text-black-900 sm:text-xl">
                      <Text
